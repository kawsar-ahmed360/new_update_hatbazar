...
{{--            <a href="{{route('VandorOrderDetailsDelete',[@$or->id,@$shop_i->shop_id])}}" style="background: red;padding: 7px;border-radius: 4px" class=""><i style="color:white" class="fa fa-trash"></i></a>--}}
            <a href="#" disabled="" style="background: red;padding: 7px;border-radius: 4px" class=""><i style="color:white" class="fa fa-trash"></i></a>
