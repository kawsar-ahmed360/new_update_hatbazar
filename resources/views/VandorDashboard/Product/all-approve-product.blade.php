                            ...
                            <td style="text-align: center;">
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <a style="display: inherit;margin: 5px;border-radius:3px" href="{{route('VandorProductEdit',[@$index->id,$index->shop_id])}}" class="btn btn-info btn-sm "><i class="fa fa-edit"></i> Edit</a>
