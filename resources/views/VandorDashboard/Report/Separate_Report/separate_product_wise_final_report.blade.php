...
@section('vandor-content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4> {{@$category->category_name}} <i class="fa fa-arrow-right"></i> {{@$product_name->product_name}} Mothly/Yearly Genarate Report:</h4>
                    ...
                    <table id="copy-print-csv" class="table table-striped " style="margin-top: 30px">
                        ...
                        @foreach(@$Report as $report)
                            @php
                                ...
                                $order_details = \App\Models\Client\OrderDetail::where('shop_id',$shop_i->shop_id)->where('order_id',$report->id)->where('cat_id',$cat_id)->where('product_id',$pro_id)->where('order_status','2')->where('shipping_status','2')->where('order_complete','2')->get()->sum('subtotal');
