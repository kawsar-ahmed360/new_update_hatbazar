                        ...
                        <form action="{{route('VandorWithdraRequestStore')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="row gutters">
                                    ...
                                    @php
                                    $pay = \App\Models\PaymentSetting::where('id','1')->first();
                                    @endphp
                                    ...
                                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-12" style="line-height: 0;">
                                        ...
                                        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-12" style="line-height: 0;display: none;" id="bkash">
                                            <div class="form-group">
                                                <input type="text" class="form-control"   id="bikash_number"  value="{{@$pay->bkash_number}}" name="bkash_number" placeholder="Enter bkash Number">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="row gutters">
                                            ...
                                            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-12" style="line-height: 0;display: none;" id="nagad">
                                                <div class="form-group">
                                                    <input type="text" class="form-control"   id="nagad_number" value="{{@$pay->nagad_number}}"  name="nagad_number" placeholder="Enter Nagad Number">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="row gutters">
                                            ...
                                            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-12" style="line-height: 0;display: none;" id="rocket">
                                                <div class="form-group">
                                                    <input type="text" class="form-control"   id="rocket_number" value="{{@$pay->rocket_number}}"  name="rocket_number" placeholder="Enter Rocket Number">
                                    ...
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="row gutters">
                                            ...
                                            <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-12" style="line-height: 0;display:none;" id="bank_account">
                                                <div class="form-group">
                                                    <input type="text" class="form-control"   id="bank_account_numberrd"  name="bank_account_number" value="{{@$pay->bank_account_no}}" placeholder="Enter Bank Account Number">
                                                    <input type="text" class="form-control"   id="bank_account_numberrd"  name="bank_branch_name" value="{{@$pay->branch_name}}" placeholder="Enter Bank Account Number">
                                                    <input type="text" class="form-control"   id="bank_account_numberrd"  name="bank_holder_name" value="{{@$pay->holder_name}}" placeholder="Enter Bank Account Number">
