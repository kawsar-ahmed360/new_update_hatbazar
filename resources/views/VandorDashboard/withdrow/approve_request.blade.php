                    ...
                    @foreach(@$panding_request as $key=>$panding)
                        <tr>
                            ...
                            <td>
                                ...
                                <a  data-toggle="modal" data-target="#basicModal{{$panding->id}}"><i  @if($panding->message==null) style="font-size: 26px;text-align: center;color:red"  @else style="font-size: 26px;text-align: center;color:forestgreen" @endif class="fa fa-envelope"></i></a>
                                <a class="" href="{{route('VandorWithdraApproveReciprtGenarate',@$panding->id)}}"><i style="font-size: 26px;text-align: center;color:red"  class="fa fa-print"></i></a>
