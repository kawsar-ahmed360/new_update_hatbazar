                        ...
                        <div class="row gutters">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    {{--<input type="text" class="form-control" id="fullName" value="{{$info->product_being_displayed??''}}" name="product_being_displayed" placeholder="Enter Description">--}}
                                    <textarea name="product_being_displayed" class="form-control" id="" cols="30" rows="4">{!! $info->product_being_displayed??'' !!}</textarea>
                                </div>
                            </div>
