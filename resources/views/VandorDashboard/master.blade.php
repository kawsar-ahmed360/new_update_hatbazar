        ...
        <div class="sidebar-content">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    {{ Request::routeIs('VandorShippingStatusApprove') ? 'active' : '' }} {{ Request::routeIs('VandorShippingStatusPanding') ? 'active' : '' }} {{ Request::routeIs('VandorCompleteStatusApporve') ? 'active' : '' }}  "  >
                        ...
                        <div class="sidebar-submenu">
                            <ul>
                                ...
                                <li>
                                    <a href="{{route('VandorApprovedOrderManage')}}">Approved List</a>
                                </li>

                                <li>
                                    <a href="{{route('VandorOrderManage')}}">Panding List</a>
                                </li>
                    ...
                    <li class="sidebar-dropdown {{ Request::routeIs('VandorReport_Genarator') ? 'active' : '' }}{{ Request::routeIs('SeparateVandorReport_GenaratorPage') ? 'active' : '' }}
                    {{ Request::routeIs('SeparateVandorReport_CategoryWiseReport') ? 'active' : '' }}{{ Request::routeIs('SeparateVandorReport_ProductWiseReport') ? 'active' : '' }}"  >
                        <a href="#">
                        ...
                        <div class="sidebar-submenu">
                            <ul>
                                ...
                                <li>
                                    <a href="{{route('SeparateVandorReport_GenaratorPage')}}">Separate Report</a>
                                </li>
                    ...
                    <li class="sidebar-dropdown {{ Request::routeIs('VandorWithdraRequest') ? 'active' : '' }} {{ Request::routeIs('VandorWithdraPandingRequest') ? 'active' : '' }} {{ Request::routeIs('VandorWithdraApproveRequest') ? 'active' : '' }}{{ Request::routeIs('VandorPaymentSetting') ? 'active' : '' }} ">
                        <a href="#">
                            <i class="">৳</i>
                        ...
                        <div class="sidebar-submenu">
                            <ul>
                                ...
                                <li>
                                    <a href="{{route('VandorPaymentSetting')}}">Payment Setting</a>
                                </li>
                ...
                <ul class="header-actions">
                    ...
                    <li class="dropdown">
                        <a href="#" id="userSettings" class="user-settings" data-toggle="dropdown" aria-haspopup="true">
                            <span class="user-name">Hello {{@$info->f_name}}</span>
                            <span class="avatar">
										<img src="{{(@$info->profile)?url('upload/Vandor/Profile/'.$info->profile):asset('upload/Vandor/default.png')}}" alt="avatar">
										<span class="status busy"></span>
									</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userSettings">
