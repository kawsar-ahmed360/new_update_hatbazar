                                        ...
                                        <table id="example" class="datatabel table table-striped table-bordered order-list-tabel" width="100%" cellspacing="0">
                                            ...
                                            @forelse(@$wishlist as $key=>$wish)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a style="min-height: 8px;min-width: 36px;font-size: 1em;padding: 0;line-height: 30px;" data-toggle="tooltip" data-placement="top" id="delete" title="" href="{{route('customerWishDelete',base64_encode($wish->id))}}" data-original-title="View Detail" class="btn btn-danger btn-sm">
                                                            <i class="mdi mdi-delete"></i>
                                                        </a>

                                                        <a style="min-height: 8px;min-width: 36px;font-size: 1em;padding: 0;line-height: 30px;" data-toggle="tooltip" data-placement="top"  title="" href="{{route('SinglePorduct',$wish->Product->slug)}}" data-original-title="View Detail" class="btn btn-info btn-sm">
