...
<a href="{{route('customerOrderList')}}" class="list-group-item list-group-item-action {{ Request::routeIs('customerOrderList') ? 'active' : '' }}  {{ Request::routeIs('customerOrderDetails') ? 'active' : '' }} {{ Request::routeIs('customerOrderCheck') ? 'active' : '' }} ">
