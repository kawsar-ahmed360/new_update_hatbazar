                                        ...
                                        <table id="example" class="datatabel table table-striped table-bordered order-list-tabel" width="100%" cellspacing="0">
                                            ...
                                            <tr>
                                                ...
                                                <td style="display: flex;">
                                                    ...
                                                    <a style="padding: 9px;border-radius: 5px 0px 6px;background: #85c443;margin: 4px;color: white;" data-toggle="tooltip" data-placement="top" title="" href="{{route('customerOrderCheck',base64_encode($order->id))}}" data-original-title="View Detail" class="">
                                                        <i style="font-size: 17px;" class="fa fa-hourglass-half"></i>
                                                    </a>
                                                </td>
                                            </tr>
