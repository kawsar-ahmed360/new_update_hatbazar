        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                ...
                <img style="border: 1px solid #8b02ff;padding:15px;border-radius: 4px;height: 59px" src="{{(@$vandor->shop_image)?url('upload/Vandor/shop_image/'.@$vandor->shop_image):url('backend/vandor_unk.png')}}" alt="">
                    ...
                    <div class="col-md-8">
                         <span><strong style="font-family: inherit;font-size:19px;font-weight: 500;"> <i class="fa fa-mobile"></i> :</strong>{{@$vandor->phone}}</span>    <span><strong style="font-family: inherit;font-size:19px;font-weight: 500;">  <i style="padding-left: 18px;" class="fa fa-envelope"></i> :</strong>{{@$vandor->email}}</span>
                        ...
                        <br>
                        <p>{!! @$vandor->product_being_displayed !!}</p>
                    </div>
