...
@section('client-content')
   ...
   {{--<!-------------Product Review Section------------>--}}
    ...
    <section class="paddingB-70 paddingT-30 ">
        <div class="container-fluid">
            <div class="xs-content-header1 version-2">
                <h2 class="xs-content-title float-left" style="color: #f113a4;"> Product Review </h2>
                <!-- <a href="#"><p class="float-right">Show More <i class="fas fa-eye"></i></p></a> -->
                <div class="clearfix"></div>
            </div>
            <div class="row">
                ...
                <!--*****************************************************************-->
                @foreach(@$product_review as $reviews)
                    <div class="col-md-6 col-lg-4" style="margin-top: 13px;">

                        <div class="" style="background: #fbfbfb;border: 1px solid #f5f5f5;padding: 15px; }">
                            <div style="line-height: 5px;">
                                 <span style="float: right;">

                                     @for($i=1; $i<=$reviews->star; $i++)
                                         <i style="color:#8e02ff;font-size: 17px;" class="mdi mdi-star-outline"></i>
                                     @endfor
                                </span>
                            <p style="">{{@$reviews->CustomerInfo->name}}</p>
                            <p style="color:#b2b2b2">date: {{date('d-m-Y',strtotime($reviews->updated_at))}}</p>
                    ...
                    {{--<div class="" style="background: #fbfbfb;border: 1px solid #f5f5f5;padding: 15px; }">--}}
                        {{--<div style="line-height: 5px;">--}}
                                 {{--<span style="float: right;">--}}
                                    ...
                                    {{--<i style="color:#8e02ff;font-size: 17px;" class="mdi mdi-star-outline"></i>--}}
                                {{--</span>--}}
                            {{--<p style="">Name: Tushar</p>--}}
                            {{--<p style="color:#b2b2b2">date: 10-02-2022</p>--}}

                        {{--</div>--}}

                        {{--<p>Product Is Vary Good, vary nice product Product Is Vary Good, vary nice product Product Is Vary Good, vary nice product</p>--}}
                    {{--</div>--}}
