                ...
                <div class="categorysection">
                  ...
                  <span class="product-categories" style="font-size: .95714em;margin-bottom: 0px;margin-top:5px">
                    <span style="color:white">{{@$shop->shop_id}}</span>
                        ...
                        <h4 class="product-title" style="line-height: 1.625;font-weight: 500;font-size: 1.14286em;"><a href="{{route('vandorShopPage',[@$shop->shop_id,@$shop->id])}}">{{@$shop->shop_name}}</a></h4>
                    </div>
                </div>
                </a>
