            ...
            <div class="col-md-6 col-lg-2" style="padding-top: 22px;">
                <div class="vendor-name">
                    ...
                    <div class="xs-product-header media">
                        <span class="value" style="background: #8e02ff;color: #fff; padding: 5px;border-radius:3px 0px 6px 0px">  {{@$product->shop_name??'unknown'}}  </span>
                    </div>
                    <!--  -->
                ...
                <div class="product-card">
                    ...
                    <div  style="margin-left: 116px;">
                        <a href="{{route('WishlistAdd',base64_encode($product->id))}}"><span class="value" style="background: #8e02ff;color: #fff; padding: 6px;position: absolute;border-radius: 29% !important;margin-left: 37px;" title="wishlist"> <i title="Wishlist" style="font-size:17px;cursor:pointer" class="fa fa-heart"></i></span></a>
                    </div>
                    <!--  -->
