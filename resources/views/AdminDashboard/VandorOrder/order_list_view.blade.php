                                        ...
                                        <table id="copy-print-csv" class="table custom-table">
                                            ...
                                            @foreach(@$order as $key=>$or)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('VandorPanelOrderDetails',[@$or->id,$shop_i->shop_id])}}" style="background: #d9b400;padding: 7px;border-radius: 4px" class=""><i style="color:white" class="fa fa-eye"></i></a>
