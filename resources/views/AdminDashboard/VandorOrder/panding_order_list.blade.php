...
@section('title') Vandor Panel All Order @endsection
                                    ...
                                    <div class="container">
                                        <table id="copy-print-csv" class="table custom-table">
                                            ...
                                            @foreach(@$order as $key=>$or)
                                                ...
                                                @php
                                                    $order_details = \App\Models\Client\OrderDetail::where('shop_id',$shop_i->shop_id)->where('order_id',$or->id)->where('order_status','1')->where('shipping_status','1')->where('order_complete','1')->get()->sum('subtotal');
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{route('VandorPanelPandingOrderDetails',[@$or->id,$shop_i->shop_id])}}" style="background: #d9b400;padding: 7px;border-radius: 4px" class=""><i style="color:white" class="fa fa-eye"></i></a>
