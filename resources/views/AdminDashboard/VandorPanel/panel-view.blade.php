                                ...
                                <div class="documents-body">
                                    ...
                                    <div class="row gutters">
                                        ...
                                        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                            <div class="doc-block">
                                                <div class="doc-icon">
                                                    <img style="height: 72px;width: 64px;" src="{{asset('backend/order.png')}}" alt="Doc Icon" />
                                                </div>
                                                <div class="doc-title">Order Manage</div>
                                                <a href="{{route('VandorOrderListView',@$vandor->shop_id)}}" class="btn btn-white btn-lg">view</a>
                                            </div>
                                        </div>
