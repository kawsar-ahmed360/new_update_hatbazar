...
@section('title') Vandor Panel Product Edit @endsection
                            ...
                            <div class="docTypeContainerScroll">
                                ...
                                <div class="docs-block">
                                    ...
                                    <div class="doc-labels">
                                        ...
                                        <a href="{{route('VandorPanelProductAll',@$vandor->shop_id)}}" class="{{ Request::routeIs('VandorPanelProductAll') ? 'active' : '' }} {{ Request::routeIs('VandorPanelProductEdit') ? 'active' : '' }} {{ Request::routeIs('VandorPanelProductUpdate') ? 'active' : '' }} ">
                    ...
                    <div class="col-xl-10 col-lg-10 col-md-9 col-sm-9 col-8">
                        ...
                        <div class="documents-container">
                            ...
                            <div class="documentsContainerScroll">
                                ...
                                <!-- Row start -->
                                <form action="{{route('VandorPanelProductUpdate')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <!--------- Add Product Section------->
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="card">
                                                ...
                                                <div class="row gutters">
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control OriginalPrice @error('product_price') is-invalid @enderror"  value="{{@$edite->product_price}}" name="product_price" id="imgInp" placeholder="Enter product_price">
                                                            @error('product_price')
                                                            <span class="invalid-feedback" role="alert">
                                                             <strong style="color:red">{{$message}}</strong>
                                                           </span>
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control @error('commission') is-invalid @enderror" name="commission" value="{{@$edite->commission}}" id="discount" placeholder="Enter commission%">
                                                            @error('commission')
                                                            <span class="invalid-feedback" role="alert">
                                                             <strong style="color:red">{{$message}}</strong>
                                                           </span>
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" readonly class="form-control @error('inc_commission_price') is-invalid @enderror" value="{{@$edite->inc_commission_price}}" name="inc_commission_price" id="newPriceComm" placeholder="Enter inc_commission_price">
                                                    ...
                                                    <div class="col-xl-12 col-lg-12-md-12 col-sm-12 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control @error('product_sku') is-invalid @enderror" name="product_sku" value="{{@$edite->product_sku}}" id="imgInp" placeholder="Enter product_sku">
                                                            @error('product_sku')
                                                            <span class="invalid-feedback" role="alert">
                                                             <strong style="color:red">{{$message}}</strong>
                                                           </span>
                                            ...
                                            margin-bottom: 5px;font-weight: normal;">Meta Title</label>
                                                                    <input type="text" class="form-control" name="meta_title" id="meta_title" value="{{@$edite->meta_title}}" placeholder="Enter meta title">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-md-12">
