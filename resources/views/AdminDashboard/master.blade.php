        ...
        <div class="sidebar-content">
            ...
            <div class="sidebar-menu">
                <ul>
                    ...
                    {{ Request::routeIs('VandorOrderListView') ? 'active' : '' }}{{ Request::routeIs('VandorPanelOrderDetails') ? 'active' : '' }}{{ Request::routeIs('VandorPanelOrderShopStatus') ? 'active' : '' }}
                    {{ Request::routeIs('VandorApprovedOrderListView') ? 'active' : '' }}{{ Request::routeIs('VandorPandingOrderListView') ? 'active' : '' }}{{ Request::routeIs('VandorPanelPandingOrderDetails') ? 'active' : '' }}
                    {{ Request::routeIs('VandorPanelApporveOrderDetails') ? 'active' : '' }} ">
                        <a href="#">
                            <i class="icon-file-text"></i>
                    ...
                    {{ Request::routeIs('AllCustomerOrderAdminStatus') ? 'active' : '' }}{{ Request::routeIs('CustomerOrderShippingCompleteDetails') ? 'active' : '' }} {{ Request::routeIs('CustomerOrderPandingDetails') ? 'active' : '' }} ">
                        <a href="#">
                            <i class="icon-circular-graph"></i>
