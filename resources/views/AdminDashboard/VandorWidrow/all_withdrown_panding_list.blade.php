                        ...
                        @foreach(@$panding_windrown_list as $key=>$panding)
                         <tr>
                             ...
                             <td>
                                 ...
                                 <a href="{{route('VandorPanelPaymentWidrowDelete',[@$panding->shop_id,@$panding->VandorInof->id,@$panding->id])}}"><span class="badge badge-danger"> <i class="fa fa-trash"></i> Delete</span></a>
                             </td>
                         </tr>
