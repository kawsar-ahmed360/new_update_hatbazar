    ...
    <div id="invoice" class="effect2">
        ...
        <div id="invoice-top">
            ...
            <div class="middle-text">
                ...
                <h1 style="padding-left: 33px;">Repeipt</h1>
                <p style="font-size: 18px;"> Shop name: <span id="invoice_date" style="font-size: 17px;font-family: cursive;"> Daraz</span></p>


                <p>Vendor Name: <span id="invoice_date"> Utpal Nondi </span><br> </p>
                <p>Vendor Mobile: <span id="invoice_date"> 01779666633  </span><br> </p>

            </div>

            <div class="vendor-logo"><img src="http://icms-image.slatic.net/images/ims-web/bfe8de2c-b737-42ab-b1f1-576042ab0412.png" alt="Logo" style="height: 42px;width: 113px;" /> </div>
            ...
            <div id="message" style="margin-bottom: 20px;">
                <table class="table table-striped" style="width: 100%;">
                    ...
                    <table class="table" style="width:100%;float: left ;margin:0 auto">
                        ...
                        <tr >
                            <th> <p>Repeipt Date: <span id="invoice_date">07 Mar 2022</span></p> </th>
                        </tr>
        ...
        <footer>
            <div id="legalcopy" class="clearfix">
                <p class="col-right"> Thank you :
                    <span class="email"> <a href="iamosahan@gmail.com"> utpal Nondi</a></span>
                </p>
            </div>
        </footer>
