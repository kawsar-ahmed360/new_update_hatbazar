...
Route::group(['middleware' => 'auth:vandor'], function () {
   ...
   //----------------------------Vandor Product Section----------------------------
    ...
    Route::get('/Vandor/vandor-product-edit/{id}/{shop_id}', [\App\Http\Controllers\Vandor\VandorProductManageController::class,'VandorProductEdit'])->name('VandorProductEdit');
    Route::post('/Vandor/vandor-product-update/', [\App\Http\Controllers\Vandor\VandorProductManageController::class,'VandorProductUpdate'])->name('VandorProductUpdate');
    ...
    Route::get('/Vandor/vandor-order-delete/{id}/{shop_id}', [\App\Http\Controllers\Vandor\VandorOrderManageController::class,'VandorOrderDetailsDelete'])->name('VandorOrderDetailsDelete');

    Route::get('/Vandor/vandor-approved-order-manage}', [\App\Http\Controllers\Vandor\VandorOrderManageController::class,'VandorApprovedOrderManage'])->name('VandorApprovedOrderManage');
...
//    route::post('Vandor/purshes_update/{id}',[\App\Http\Controllers\Vandor\VadorPurchesManageController::class,'purshesadd_update'])->name('purshesadd_update');
    ...
    //----------------------------Vandor Separate Report Section----------------------

    route::get('Vandor/separate_report_genarate-page',[\App\Http\Controllers\Vandor\VadorReportGenarateController::class,'SeparateVandorReport_GenaratorPage'])->name('SeparateVandorReport_GenaratorPage');
    route::post('Vandor/separate_report_category_wise_report',[\App\Http\Controllers\Vandor\VadorReportGenarateController::class,'SeparateVandorReport_CategoryWiseReport'])->name('SeparateVandorReport_CategoryWiseReport');
    route::post('Vandor/separate_report_product_wise_report',[\App\Http\Controllers\Vandor\VadorReportGenarateController::class,'SeparateVandorReport_ProductWiseReport'])->name('SeparateVandorReport_ProductWiseReport');

    route::get('Vandor/separate_report_category_wise_product_ajax',[\App\Http\Controllers\Vandor\VadorReportGenarateController::class,'SeparateVandorReportCategoryWiseProductAjax'])->name('SeparateVandorReportCategoryWiseProductAjax');
    ...
    Route::get('/Vandor/vandor-withdraw-approve-recipt-genarate/{id}', [\App\Http\Controllers\Vandor\VandorWithDrawRequestController::class,'VandorWithdraApproveReciprtGenarate'])->name('VandorWithdraApproveReciprtGenarate');
    ...
    Route::get('/Vandor/vandor-payment-setting', [\App\Http\Controllers\Vandor\VandorWithDrawRequestController::class,'VandorPaymentSetting'])->name('VandorPaymentSetting');
    Route::post('/Vandor/vandor-payment-setting-bkash-number', [\App\Http\Controllers\Vandor\VandorWithDrawRequestController::class,'VandorPaymentSettingBkashNumber'])->name('VandorPaymentSettingBkashNumber');
    Route::post('/Vandor/vandor-payment-setting-rocket-number', [\App\Http\Controllers\Vandor\VandorWithDrawRequestController::class,'VandorPaymentSettingRocketNumber'])->name('VandorPaymentSettingRocketNumber');
    Route::post('/Vandor/vandor-payment-setting-nogad-number', [\App\Http\Controllers\Vandor\VandorWithDrawRequestController::class,'VandorPaymentSettingNogadNumber'])->name('VandorPaymentSettingNogadNumber');
    Route::post('/Vandor/vandor-payment-setting-bank-info', [\App\Http\Controllers\Vandor\VandorWithDrawRequestController::class,'VandorPaymentSettingBankInfo'])->name('VandorPaymentSettingBankInfo');
