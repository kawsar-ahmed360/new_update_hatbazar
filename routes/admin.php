...
Route::group(['middleware' => 'auth:admin'], function () {
    ...
    Route::get('SuperAdmin/Order/order-details/{id}/{shop_id}',[OrderManageAdmin::class,'AllCustomerOrderDetails'])->name('AllCustomerOrderDetails');
    Route::get('SuperAdmin/Order/order-admin-status/{id}/{shop_id}',[OrderManageAdmin::class,'AllCustomerOrderAdminStatus'])->name('AllCustomerOrderAdminStatus');
    Route::get('SuperAdmin/Order/order-delete/{id}',[OrderManageAdmin::class,'AllCustomerOrderDelete'])->name('AllCustomerOrderDelete');


    //......................................NEW Order Status------------------
    Route::get('SuperAdmin/PandingOrder/customer_order_approve/{id}/{shop_id}',[OrderManageAdmin::class,'CustomerOrderApprove'])->name('CustomerOrderApprove');
    Route::get('SuperAdmin/PandingOrder/customer_order_panding/{id}/{shop_id}',[OrderManageAdmin::class,'CustomerOrderPanding'])->name('CustomerOrderPanding');
    Route::get('SuperAdmin/PandingOrder/customer_order_shipping_approve/{id}/{shop_id}',[OrderManageAdmin::class,'CustomerOrderShippingApprove'])->name('CustomerOrderShippingApprove');
    Route::get('SuperAdmin/PandingOrder/customer_order_shipping_panding/{id}/{shop_id}',[OrderManageAdmin::class,'CustomerOrderShippingPanding'])->name('CustomerOrderShippingPanding');
    Route::get('SuperAdmin/PandingOrder/customer_order_shipping_complete/{id}/{shop_id}',[OrderManageAdmin::class,'CustomerOrderShippingComplete'])->name('CustomerOrderShippingComplete');
    Route::get('SuperAdmin/PandingOrder/customer_order_shipping_complete_panding/{id}/{shop_id}',[OrderManageAdmin::class,'CustomerOrderShippingCompletePanding'])->name('CustomerOrderShippingCompletePanding');

    //---------------------------------Order Panding And Approved Details----------------

    Route::get('SuperAdmin/PandingOrder/customer_order_shipping_complete_details/{id}/{shop_id}',[OrderManageAdmin::class,'CustomerOrderShippingCompleteDetails'])->name('CustomerOrderShippingCompleteDetails');
    Route::get('SuperAdmin/PandingOrder/customer_order_panding-details/{id}/{shop_id}',[OrderManageAdmin::class,'CustomerOrderPandingDetails'])->name('CustomerOrderPandingDetails');
    ...
    route::get('SuperAdmin/Vandor/vandor-panel-widrow-delete/{shop_page}/{id}/{request_id}',[VandorReviewManageController::class,'VandorPanelPaymentWidrowDelete'])->name('VandorPanelPaymentWidrowDelete');
    ...
    //-------------------------Vandor Order List View-----------------------
    route::get('SuperAdmin/Vandor/vandor-order-list/{shop_id}',[VandorReviewManageController::class,'VandorOrderListView'])->name('VandorOrderListView');
    route::get('SuperAdmin/Vandor/vandor-approve-order-list/{shop_id}',[VandorReviewManageController::class,'VandorApprovedOrderListView'])->name('VandorApprovedOrderListView');
    route::get('SuperAdmin/Vandor/vandor-panding-order-list/{shop_id}',[VandorReviewManageController::class,'VandorPandingOrderListView'])->name('VandorPandingOrderListView');
    route::get('SuperAdmin/Vandor/vandor-order-approve-details/{id}/{shop_id}',[VandorReviewManageController::class,'VandorPanelApporveOrderDetails'])->name('VandorPanelApporveOrderDetails');
    route::get('SuperAdmin/Vandor/vandor-order-panding-details/{id}/{shop_id}',[VandorReviewManageController::class,'VandorPanelPandingOrderDetails'])->name('VandorPanelPandingOrderDetails');
    route::get('SuperAdmin/Vandor/vandor-order-details/{id}/{shop_id}',[VandorReviewManageController::class,'VandorPanelOrderDetails'])->name('VandorPanelOrderDetails');
    route::get('SuperAdmin/Vandor/vandor-order-shop-status/{id}/{shop_id}',[VandorReviewManageController::class,'VandorPanelOrderShopStatus'])->name('VandorPanelOrderShopStatus');
