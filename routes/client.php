...
Route::get('/category-select-shop-page',[FontController::class,'CategoryShopSelectPage'])->name('CategoryShopSelectPage');
Route::get('/category-single-page-shop-page/{id}',[FontController::class,'CategorySingleShopSelectPage'])->name('CategorySingleShopSelectPage');
...
Route::group(['middleware' => 'customer_auth'], function () {
    ...
    route::get('order-status-check/{id}',[OrderController::class,'customerOrderCheck'])->name('customerOrderCheck');
