...
class ProductManageController extends Controller
{
    ...
    public function ProductIndex(){
        $data['product'] = ProductManage::OrderBy('id','desc')->where('shop_id','WE-11')->get();
    ...
    public function ProductEdite($id){
        ...
        $data['plation'] = Plating::get();
        $data['section'] = SectionManage::get();
        $data['edite'] = ProductManage::where('id',$id)->where('shop_id','WE-11')->first();
        //----------------Section Decode-------------
        $section_decode = ProductManage::where('id',$id)->where('shop_id','WE-11')->first()->section_id;
