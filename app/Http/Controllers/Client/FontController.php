...
class FontController extends Controller
{
    ...
    public function SinglePorduct($slug){
        ...
        $data['related_product'] = ProductManage::where('status','1')->where('cat_id',$data['product_details']->cat_id)->get()->take(12);
...
//        $data['color_name'] = ColorManage::whereIn('id',$json_d)->get();
    ...
    public function CategoryShopSelectPage(Request $request){
        $id = $request->cat_id_form;
    ...
    public function CategorySingleShopSelectPage($id){
